...
RSpec.describe 'AUCoreTestKit::MustSupportTest' do
  it 'Should return all extensions' do
    ...
    expected_result = [
      { 'url' => 'http://hl7.org.au/fhir/StructureDefinition/date-accuracy-indicator',
        'valueCoding' => { 'code' => 'AAA',
                           'system' => 'https://healthterminologies.gov.au/fhir/CodeSystem/date-accuracy-indicator-1', 'display' => 'Day, month and year are accurate' } },
      ...
      { 'url' => 'http://hl7.org.au/fhir/StructureDefinition/indigenous-status',
        'valueCoding' => { 'system' => 'https://healthterminologies.gov.au/fhir/CodeSystem/australian-indigenous-status-1',
                           'code' => '4', 'display' => 'Neither Aboriginal nor Torres Strait Islander origin' } },
      { 'url' => 'http://hl7.org/fhir/StructureDefinition/patient-birthPlace',
        'valueAddress' => { 'text' => 'China', 'country' => 'CHN' } },
      { 'url' => 'http://hl7.org.au/fhir/StructureDefinition/ihi-status',
        'valueCoding' => { 'system' => 'https://healthterminologies.gov.au/fhir/CodeSystem/ihi-status-1',
                           'code' => 'active' } },
      { 'url' => 'http://hl7.org.au/fhir/StructureDefinition/ihi-record-status',
        'valueCoding' => { 'system' => 'https://healthterminologies.gov.au/fhir/CodeSystem/ihi-record-status-1', 'code' => 'verified', 'display' => 'verified' } }
    ]
