...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class AllergyIntolerancePatientClinicalStatusSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for AllergyIntolerance search by patient + clinical-status'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_allergy_intolerance_patient_clinical_status_search_test
      optional
      ...
      def self.properties
        @properties ||= SearchTestProperties.new(
          ...
          search_param_names: %w[patient clinical-status],
