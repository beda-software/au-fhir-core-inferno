...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class AllergyIntolerancePatient_IHI_ChainSearchTest < Inferno::Test
      include AUCoreTestKit::ChainedSearchTest

      title '(SHOULD) Server returns valid results for AllergyIntolerance search by patient (IHI) (chained parameters)'
      description %(A server SHOULD support searching by
patient:Patient.identifier (IHI) on the AllergyIntolerance resource. This test
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_allergy_intolerance_patient_ihi_chain_search_test
