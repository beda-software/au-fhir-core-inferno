...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class MedicationStatementPatientChainSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for MedicationStatement search by patient (chained parameters)'
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_medication_statement_patient_chain_search_test
