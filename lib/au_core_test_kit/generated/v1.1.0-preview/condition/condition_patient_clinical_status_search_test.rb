...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class ConditionPatientClinicalStatusSearchTest < Inferno::Test
      ...
      title '(SHALL) Server returns valid results for Condition search by patient + clinical-status'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_condition_patient_clinical_status_search_test
      input :patient_ids,
            title: 'Patient IDs',
