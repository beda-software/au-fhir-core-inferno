...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_condition_patient_category_clinical_status_search_test
      optional
      ...
      def self.properties
        @properties ||= SearchTestProperties.new(
          ...
          search_param_names: %w[patient category clinical-status],
          token_search_params: %w[category clinical-status]
        )
      end
