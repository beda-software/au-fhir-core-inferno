...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class ConditionPatient_DVA_ChainSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for Condition search by patient (DVA) (chained parameters)'
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_condition_patient_dva_chain_search_test
