...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class PatientGender_identityMultipleOrSearchTest < Inferno::Test
      include AUCoreTestKit::SearchTest

      title '(MAY) Server returns valid results for Patient multipleOr search by gender-identity'
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_patient_gender_identity_multiple_or_search_test
