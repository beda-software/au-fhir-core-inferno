...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class EncounterClassPatientSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for Encounter search by class + patient'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_encounter_class_patient_search_test
      optional
      ...
      def self.properties
        @properties ||= SearchTestProperties.new(
          ...
          search_param_names: %w[class patient],
