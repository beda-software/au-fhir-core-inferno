...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class MedicationRequestPatientIntentSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for MedicationRequest search by patient + intent'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_medication_request_patient_intent_search_test
      optional
