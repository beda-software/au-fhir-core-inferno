...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class MedicationRequestPatient_IHI_ChainSearchTest < Inferno::Test
      include AUCoreTestKit::ChainedSearchTest

      title '(SHOULD) Server returns valid results for MedicationRequest search by patient (IHI) (chained parameters)'
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_medication_request_patient_ihi_chain_search_test
