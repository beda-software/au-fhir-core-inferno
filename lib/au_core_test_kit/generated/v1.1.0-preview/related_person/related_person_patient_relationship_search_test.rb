...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class RelatedPersonPatientRelationshipSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for RelatedPerson search by patient + relationship'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_related_person_patient_relationship_search_test
      optional
      ...
      def self.properties
        @properties ||= SearchTestProperties.new(
          ...
          search_param_names: %w[patient relationship],
