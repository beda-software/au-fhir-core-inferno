...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class RelatedPersonPatientSearchTest < Inferno::Test
      include AUCoreTestKit::SearchTest

      title '(SHALL) Server returns valid results for RelatedPerson search by patient'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_related_person_patient_search_test
      input :patient_ids,
            title: 'Patient IDs',
