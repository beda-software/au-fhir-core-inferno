...
module AUCoreTestKit
  module AUCoreV110_PREVIEW
    class ProcedurePatient_DVA_ChainSearchTest < Inferno::Test
      include AUCoreTestKit::ChainedSearchTest

      title '(SHOULD) Server returns valid results for Procedure search by patient (DVA) (chained parameters)'
      description %(A server SHOULD support searching by
patient:Patient.identifier (DVA) on the Procedure resource. This test
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/1.1.0-preview/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v110_preview_procedure_patient_dva_chain_search_test
