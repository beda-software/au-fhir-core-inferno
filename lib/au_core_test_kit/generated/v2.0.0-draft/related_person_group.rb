...
read succeeds.
      ...
      test from: :au_core_v200_draft_related_person_patient_search_test
      test from: :au_core_v200_draft_related_person__id_search_test
      test from: :au_core_v200_draft_related_person_name_search_test
      test from: :au_core_v200_draft_related_person_relationship_search_test
      test from: :au_core_v200_draft_related_person_patient_relationship_search_test
      test from: :au_core_v200_draft_related_person_patient_name_search_test
      test from: :au_core_v200_draft_related_person_read_test
      test from: :au_core_v200_draft_related_person_validation_test
      test from: :au_core_v200_draft_related_person_must_support_test
      test from: :au_core_v200_draft_related_person_reference_resolution_test
    end
  end
end
