...
read succeeds.
      ...
      test from: :au_core_v200_draft_patient__id_search_test
      test from: :au_core_v200_draft_patient_birthdate_search_test
      test from: :au_core_v200_draft_patient_family_search_test
      test from: :au_core_v200_draft_patient_gender_search_test
      test from: :au_core_v200_draft_patient_indigenous_status_search_test
      test from: :au_core_v200_draft_patient_identifier_search_test
      test from: :au_core_v200_draft_patient_name_search_test
      test from: :au_core_v200_draft_patient_gender_identity_search_test
      test from: :au_core_v200_draft_patient_birthdate_family_search_test
      test from: :au_core_v200_draft_patient_birthdate_name_search_test
      test from: :au_core_v200_draft_patient_family_gender_search_test
      test from: :au_core_v200_draft_patient_gender_name_search_test
      test from: :au_core_v200_draft_patient_indigenous_status_multiple_or_search_test
      test from: :au_core_v200_draft_patient_gender_identity_multiple_or_search_test
      test from: :au_core_v200_draft_patient_birthdate_multiple_and_search_test
      test from: :au_core_v200_draft_patient_indigenous_status_multiple_and_search_test
      test from: :au_core_v200_draft_patient_gender_identity_multiple_and_search_test
      test from: :au_core_v200_draft_patient_identifier_ihi_search_test
      test from: :au_core_v200_draft_patient_identifier_medicare_search_test
      test from: :au_core_v200_draft_patient_identifier_dva_search_test
      test from: :au_core_v200_draft_patient_read_test
      test from: :au_core_v200_draft_patient_validation_test
      test from: :au_core_v200_draft_patient_must_support_test
    end
  end
end
