...
read succeeds.
      ...
      test from: :au_core_v200_draft_practitioner_role_read_test
      test from: :au_core_v200_draft_practitioner_role__id_search_test
      test from: :au_core_v200_draft_practitioner_role_identifier_search_test
      test from: :au_core_v200_draft_practitioner_role_practitioner_search_test
      test from: :au_core_v200_draft_practitioner_role_specialty_search_test
      test from: :au_core_v200_draft_practitioner_role_role_search_test
      test from: :au_core_v200_draft_practitioner_role_organization_search_test
      test from: :au_core_v200_draft_practitioner_role_practitioner_multiple_or_search_test
      test from: :au_core_v200_draft_practitioner_role_practitioner_multiple_and_search_test
      test from: :au_core_v200_draft_practitioner_role_practitioner_chain_search_test
      test from: :au_core_v200_draft_practitioner_role_identifier_medicare_search_test
      test from: :au_core_v200_draft_practitioner_role__id_include__id_search_test
      test from: :au_core_v200_draft_practitioner_role_identifier_include_identifier_search_test
      test from: :au_core_v200_draft_practitioner_role_practitioner_include_practitioner_search_test
      test from: :au_core_v200_draft_practitioner_role_specialty_include_specialty_search_test
      test from: :au_core_v200_draft_practitioner_role_validation_test
      test from: :au_core_v200_draft_practitioner_role_must_support_test
      test from: :au_core_v200_draft_practitioner_role_reference_resolution_test
    end
  end
end
