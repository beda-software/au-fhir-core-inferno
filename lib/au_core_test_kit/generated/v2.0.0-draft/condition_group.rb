...
read succeeds.
      ...
      test from: :au_core_v200_draft_condition_patient_search_test
      test from: :au_core_v200_draft_condition_category_search_test
      test from: :au_core_v200_draft_condition_clinical_status_search_test
      test from: :au_core_v200_draft_condition_code_search_test
      test from: :au_core_v200_draft_condition_onset_date_search_test
      test from: :au_core_v200_draft_condition_patient_category_search_test
      test from: :au_core_v200_draft_condition_patient_clinical_status_search_test
      test from: :au_core_v200_draft_condition_patient_category_clinical_status_search_test
      test from: :au_core_v200_draft_condition_patient_code_search_test
      test from: :au_core_v200_draft_condition_patient_onset_date_search_test
      test from: :au_core_v200_draft_condition_code_multiple_or_search_test
      test from: :au_core_v200_draft_condition_onset_date_multiple_and_search_test
      test from: :au_core_v200_draft_condition_patient_chain_search_test
      test from: :au_core_v200_draft_condition_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_condition_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_condition_patient_dva_chain_search_test
      test from: :au_core_v200_draft_condition_read_test
      test from: :au_core_v200_draft_condition_validation_test
      test from: :au_core_v200_draft_condition_must_support_test
      test from: :au_core_v200_draft_condition_reference_resolution_test
    end
  end
end
