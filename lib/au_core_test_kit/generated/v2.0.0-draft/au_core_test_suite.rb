...
require_relative '../../custom_groups/v0.3.0-ballot/tement/capability_statement_group'
  ...
  module AUCoreV200_DRAFT
    class AUCoreTestSuite < Inferno::TestSuite
      ...
      group do
        ...
        group from: :au_core_v200_draft_bodyweight

        group from: :au_core_v200_draft_bloodpressure

        group from: :au_core_v200_draft_bodyheight

        group from: :au_core_v200_draft_diagnosticresult_path

        group from: :au_core_v200_draft_bodytemp

        group from: :au_core_v200_draft_heartrate

        group from: :au_core_v200_draft_waistcircum

        group from: :au_core_v200_draft_resprate

        group from: :au_core_v200_draft_diagnosticresult

        group from: :au_core_v200_draft_smokingstatus

        group from: :au_core_v200_draft_allergy_intolerance

        group from: :au_core_v200_draft_condition

        group from: :au_core_v200_draft_encounter

        group from: :au_core_v200_draft_immunization

        group from: :au_core_v200_draft_medication_request

        group from: :au_core_v200_draft_medication_statement

        group from: :au_core_v200_draft_procedure

        group from: :au_core_v200_draft_related_person

        group from: :au_core_v200_draft_healthcare_service

        group from: :au_core_v200_draft_location

        group from: :au_core_v200_draft_organization

        group from: :au_core_v200_draft_practitioner

        group from: :au_core_v200_draft_practitioner_role
