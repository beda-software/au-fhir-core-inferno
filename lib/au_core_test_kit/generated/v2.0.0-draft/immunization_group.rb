...
read succeeds.
      ...
      test from: :au_core_v200_draft_immunization_patient_search_test
      test from: :au_core_v200_draft_immunization_date_search_test
      test from: :au_core_v200_draft_immunization_status_search_test
      test from: :au_core_v200_draft_immunization_vaccine_code_search_test
      test from: :au_core_v200_draft_immunization_patient_status_search_test
      test from: :au_core_v200_draft_immunization_patient_date_search_test
      test from: :au_core_v200_draft_immunization_patient_vaccine_code_search_test
      test from: :au_core_v200_draft_immunization_vaccine_code_multiple_or_search_test
      test from: :au_core_v200_draft_immunization_date_multiple_and_search_test
      test from: :au_core_v200_draft_immunization_patient_chain_search_test
      test from: :au_core_v200_draft_immunization_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_immunization_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_immunization_patient_dva_chain_search_test
      test from: :au_core_v200_draft_immunization_read_test
      test from: :au_core_v200_draft_immunization_validation_test
      test from: :au_core_v200_draft_immunization_must_support_test
      test from: :au_core_v200_draft_immunization_reference_resolution_test
    end
  end
end
