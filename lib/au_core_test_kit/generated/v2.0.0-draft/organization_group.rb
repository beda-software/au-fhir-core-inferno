...
read succeeds.
      ...
      test from: :au_core_v200_draft_organization_read_test
      test from: :au_core_v200_draft_organization__id_search_test
      test from: :au_core_v200_draft_organization_address_search_test
      test from: :au_core_v200_draft_organization_identifier_search_test
      test from: :au_core_v200_draft_organization_name_search_test
      test from: :au_core_v200_draft_organization_identifier_hpio_search_test
      test from: :au_core_v200_draft_organization_identifier_abn_search_test
      test from: :au_core_v200_draft_organization_validation_test
      test from: :au_core_v200_draft_organization_must_support_test
    end
  end
end
