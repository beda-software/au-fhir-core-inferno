...
read succeeds.
      ...
      id :au_core_v200_draft_bodytemp
      run_as_group
      ...
      test from: :au_core_v200_draft_bodytemp_patient_code_search_test
      test from: :au_core_v200_draft_bodytemp_category_search_test
      test from: :au_core_v200_draft_bodytemp_code_search_test
      test from: :au_core_v200_draft_bodytemp_date_search_test
      test from: :au_core_v200_draft_bodytemp_status_search_test
      test from: :au_core_v200_draft_bodytemp_patient_search_test
      test from: :au_core_v200_draft_bodytemp_patient_category_search_test
      test from: :au_core_v200_draft_bodytemp_patient_category_date_search_test
      test from: :au_core_v200_draft_bodytemp_patient_category_status_search_test
      test from: :au_core_v200_draft_bodytemp_patient_code_date_search_test
      test from: :au_core_v200_draft_bodytemp_code_multiple_or_search_test
      test from: :au_core_v200_draft_bodytemp_status_multiple_or_search_test
      test from: :au_core_v200_draft_bodytemp_date_multiple_and_search_test
      test from: :au_core_v200_draft_bodytemp_patient_chain_search_test
      test from: :au_core_v200_draft_bodytemp_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_bodytemp_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_bodytemp_patient_dva_chain_search_test
      test from: :au_core_v200_draft_bodytemp_read_test
      test from: :au_core_v200_draft_bodytemp_validation_test
      test from: :au_core_v200_draft_bodytemp_must_support_test
      test from: :au_core_v200_draft_bodytemp_reference_resolution_test
    end
  end
end
