...
read succeeds.
      ...
      test from: :au_core_v200_draft_practitioner_read_test
      test from: :au_core_v200_draft_practitioner__id_search_test
      test from: :au_core_v200_draft_practitioner_identifier_search_test
      test from: :au_core_v200_draft_practitioner_name_search_test
      test from: :au_core_v200_draft_practitioner_identifier_hpii_search_test
      test from: :au_core_v200_draft_practitioner_validation_test
      test from: :au_core_v200_draft_practitioner_must_support_test
    end
  end
end
