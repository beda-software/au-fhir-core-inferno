...
module AUCoreTestKit
  module AUCoreV200_DRAFT
    class HeartrateGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the server capabilities required by the AU Core Heart Rate.'
      description %(
  # Background
...
read succeeds.
      ...
      id :au_core_v200_draft_heartrate
      run_as_group
      ...
      test from: :au_core_v200_draft_heartrate_patient_code_search_test
      test from: :au_core_v200_draft_heartrate_category_search_test
      test from: :au_core_v200_draft_heartrate_code_search_test
      test from: :au_core_v200_draft_heartrate_date_search_test
      test from: :au_core_v200_draft_heartrate_status_search_test
      test from: :au_core_v200_draft_heartrate_patient_search_test
      test from: :au_core_v200_draft_heartrate_patient_category_search_test
      test from: :au_core_v200_draft_heartrate_patient_category_date_search_test
      test from: :au_core_v200_draft_heartrate_patient_category_status_search_test
      test from: :au_core_v200_draft_heartrate_patient_code_date_search_test
      test from: :au_core_v200_draft_heartrate_code_multiple_or_search_test
      test from: :au_core_v200_draft_heartrate_status_multiple_or_search_test
      test from: :au_core_v200_draft_heartrate_date_multiple_and_search_test
      test from: :au_core_v200_draft_heartrate_patient_chain_search_test
      test from: :au_core_v200_draft_heartrate_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_heartrate_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_heartrate_patient_dva_chain_search_test
      test from: :au_core_v200_draft_heartrate_read_test
      test from: :au_core_v200_draft_heartrate_validation_test
      test from: :au_core_v200_draft_heartrate_must_support_test
      test from: :au_core_v200_draft_heartrate_reference_resolution_test
    end
  end
end
