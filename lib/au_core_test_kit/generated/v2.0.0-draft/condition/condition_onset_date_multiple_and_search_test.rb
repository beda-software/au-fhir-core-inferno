...
module AUCoreTestKit
  module AUCoreV200_DRAFT
    class ConditionOnset_dateMultipleAndSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHOULD) Server returns valid results for Condition multipleAnd search by onset-date'
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/2.0.0-draft/CapabilityStatement-au-core-server.html)
      ...
      def self.properties
        @properties ||= InfernoSuiteGenerator::SearchTestProperties.new(resource_type: 'Condition',
