...
module AUCoreTestKit
  module AUCoreV200_DRAFT
    class WaistcircumValidationTest < Inferno::Test
      include InfernoSuiteGenerator::ValidationTest

      id :au_core_v200_draft_waistcircum_validation_test
      title 'Observation resources returned during previous tests conform to the AU Core Waist Circumference'
      description %(
