...
read succeeds.
      ...
      id :au_core_v200_draft_smokingstatus
      run_as_group

      def self.metadata
        @metadata ||= InfernoSuiteGenerator::Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'smokingstatus', 'metadata.yml'), aliases: true))
      end

      test from: :au_core_v200_draft_smokingstatus_patient_code_search_test
      test from: :au_core_v200_draft_smokingstatus_category_search_test
      test from: :au_core_v200_draft_smokingstatus_code_search_test
      test from: :au_core_v200_draft_smokingstatus_date_search_test
      test from: :au_core_v200_draft_smokingstatus_status_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_category_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_category_date_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_category_status_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_code_date_search_test
      test from: :au_core_v200_draft_smokingstatus_code_multiple_or_search_test
      test from: :au_core_v200_draft_smokingstatus_status_multiple_or_search_test
      test from: :au_core_v200_draft_smokingstatus_date_multiple_and_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_chain_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_smokingstatus_patient_dva_chain_search_test
      test from: :au_core_v200_draft_smokingstatus_read_test
      test from: :au_core_v200_draft_smokingstatus_validation_test
      test from: :au_core_v200_draft_smokingstatus_must_support_test
      test from: :au_core_v200_draft_smokingstatus_reference_resolution_test
    end
  end
end
