...
read succeeds.
      ...
      test from: :au_core_v200_draft_location_read_test
      test from: :au_core_v200_draft_location_address_search_test
      test from: :au_core_v200_draft_location_name_search_test
      test from: :au_core_v200_draft_location_address_city_search_test
      test from: :au_core_v200_draft_location_address_state_search_test
      test from: :au_core_v200_draft_location_address_postalcode_search_test
      test from: :au_core_v200_draft_location_validation_test
      test from: :au_core_v200_draft_location_must_support_test
      test from: :au_core_v200_draft_location_reference_resolution_test
    end
  end
end
