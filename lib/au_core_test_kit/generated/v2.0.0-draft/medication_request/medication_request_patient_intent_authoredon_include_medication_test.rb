...
module AUCoreTestKit
  module AUCoreV200_DRAFT
    class MedicationRequestPatientIntentAuthoredonIncludeMedicationTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest
      title 'Server returns Medication resources from MedicationRequest search by patient, intent, authoredon and MedicationRequest:medication'
      description %(
