...
module AUCoreTestKit
  module AUCoreV200_DRAFT
    class MedicationRequestPatientIntentStatusIncludeMedicationTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest
      title 'Server returns Medication resources from MedicationRequest search by patient, intent, status and MedicationRequest:medication'
      description %(
