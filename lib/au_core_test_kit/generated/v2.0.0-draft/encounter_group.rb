...
read succeeds.
      ...
      test from: :au_core_v200_draft_encounter_patient_search_test
      test from: :au_core_v200_draft_encounter_class_search_test
      test from: :au_core_v200_draft_encounter_date_search_test
      test from: :au_core_v200_draft_encounter_location_search_test
      test from: :au_core_v200_draft_encounter_status_search_test
      test from: :au_core_v200_draft_encounter_date_patient_search_test
      test from: :au_core_v200_draft_encounter_class_patient_search_test
      test from: :au_core_v200_draft_encounter_patient_location_search_test
      test from: :au_core_v200_draft_encounter_patient_status_search_test
      test from: :au_core_v200_draft_encounter_status_multiple_or_search_test
      test from: :au_core_v200_draft_encounter_date_multiple_and_search_test
      test from: :au_core_v200_draft_encounter_patient_chain_search_test
      test from: :au_core_v200_draft_encounter_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_encounter_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_encounter_patient_dva_chain_search_test
      test from: :au_core_v200_draft_encounter_read_test
      test from: :au_core_v200_draft_encounter_validation_test
      test from: :au_core_v200_draft_encounter_must_support_test
      test from: :au_core_v200_draft_encounter_reference_resolution_test
    end
  end
end
