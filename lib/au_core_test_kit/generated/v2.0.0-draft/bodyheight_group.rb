...
require_relative 'bodyheight/bodyheight_patient_ihi_chain_search_test'
require_relative 'bodyheight/bodyheight_patient_medicare_chain_search_test'
require_relative 'bodyheight/bodyheight_patient_dva_chain_search_test'
...
read succeeds.
      ...
      def self.metadata
        @metadata ||= InfernoSuiteGenerator::Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'bodyheight', 'metadata.yml'), aliases: true))
      end

      test from: :au_core_v200_draft_bodyheight_patient_code_search_test
      test from: :au_core_v200_draft_bodyheight_category_search_test
      test from: :au_core_v200_draft_bodyheight_code_search_test
      test from: :au_core_v200_draft_bodyheight_date_search_test
      test from: :au_core_v200_draft_bodyheight_status_search_test
      test from: :au_core_v200_draft_bodyheight_patient_search_test
      test from: :au_core_v200_draft_bodyheight_patient_category_search_test
      test from: :au_core_v200_draft_bodyheight_patient_category_date_search_test
      test from: :au_core_v200_draft_bodyheight_patient_category_status_search_test
      test from: :au_core_v200_draft_bodyheight_patient_code_date_search_test
      test from: :au_core_v200_draft_bodyheight_code_multiple_or_search_test
      test from: :au_core_v200_draft_bodyheight_status_multiple_or_search_test
      test from: :au_core_v200_draft_bodyheight_date_multiple_and_search_test
      test from: :au_core_v200_draft_bodyheight_patient_chain_search_test
      test from: :au_core_v200_draft_bodyheight_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_bodyheight_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_bodyheight_patient_dva_chain_search_test
      test from: :au_core_v200_draft_bodyheight_read_test
      test from: :au_core_v200_draft_bodyheight_validation_test
      test from: :au_core_v200_draft_bodyheight_must_support_test
      test from: :au_core_v200_draft_bodyheight_reference_resolution_test
    end
  end
end
