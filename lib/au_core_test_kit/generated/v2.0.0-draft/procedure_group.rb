...
read succeeds.
      ...
      test from: :au_core_v200_draft_procedure_patient_search_test
      test from: :au_core_v200_draft_procedure_code_search_test
      test from: :au_core_v200_draft_procedure_date_search_test
      test from: :au_core_v200_draft_procedure_status_search_test
      test from: :au_core_v200_draft_procedure_patient_date_search_test
      test from: :au_core_v200_draft_procedure_patient_code_date_search_test
      test from: :au_core_v200_draft_procedure_patient_status_search_test
      test from: :au_core_v200_draft_procedure_code_multiple_or_search_test
      test from: :au_core_v200_draft_procedure_status_multiple_or_search_test
      test from: :au_core_v200_draft_procedure_date_multiple_and_search_test
      test from: :au_core_v200_draft_procedure_patient_chain_search_test
      test from: :au_core_v200_draft_procedure_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_procedure_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_procedure_patient_dva_chain_search_test
      test from: :au_core_v200_draft_procedure_read_test
      test from: :au_core_v200_draft_procedure_validation_test
      test from: :au_core_v200_draft_procedure_must_support_test
      test from: :au_core_v200_draft_procedure_reference_resolution_test
    end
  end
end
