...
read succeeds.
      ...
      test from: :au_core_v200_draft_bloodpressure_patient_code_search_test
      test from: :au_core_v200_draft_bloodpressure_category_search_test
      test from: :au_core_v200_draft_bloodpressure_code_search_test
      test from: :au_core_v200_draft_bloodpressure_date_search_test
      test from: :au_core_v200_draft_bloodpressure_status_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_category_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_category_date_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_category_status_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_code_date_search_test
      test from: :au_core_v200_draft_bloodpressure_code_multiple_or_search_test
      test from: :au_core_v200_draft_bloodpressure_status_multiple_or_search_test
      test from: :au_core_v200_draft_bloodpressure_date_multiple_and_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_chain_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_ihi_chain_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_medicare_chain_search_test
      test from: :au_core_v200_draft_bloodpressure_patient_dva_chain_search_test
      test from: :au_core_v200_draft_bloodpressure_read_test
      test from: :au_core_v200_draft_bloodpressure_validation_test
      test from: :au_core_v200_draft_bloodpressure_must_support_test
      test from: :au_core_v200_draft_bloodpressure_reference_resolution_test
    end
  end
end
